[Расчет продуктовых метрик для игрового приложения.ipynb](https://github.com/Nattolina/Portfolio/blob/main/Тестовое%20на%20продуктового%20аналитика/Тестовое%20на%20продуктового%20аналитика.ipynb)
